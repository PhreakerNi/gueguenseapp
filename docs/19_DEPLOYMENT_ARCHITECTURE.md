...
* **Criterio Forward-Fix:** Ante fallos de esquema, se prefiere aplicar una migración correctiva *forward-fix* sobre un *rollback* destructivo.
...
* **Política de Backups & Restore Drills:** Point-In-Time Recovery (PITR) y backups diarios habilitados según el plan del proveedor Supabase. Se programa un ejercicio de simulación de restauración (*Restore Drill*) semestral liderado por el Lead DevOps.
