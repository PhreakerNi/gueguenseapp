...
**Directiva Vigente:** `Gueguense_Paquete_Unico_Cerebro_Agente_Fase1_Cierre_CI_v1_7.md`
...
- **Backend / DB:** `Supabase CLI 2.110.0` (PostgreSQL 15+, PostGIS, RLS Deny por defecto, SELECT grants para `authenticated`)
