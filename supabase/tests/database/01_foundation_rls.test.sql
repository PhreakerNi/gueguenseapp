...
-- 5. Behavioral Security Fixtures Setup
...
INSERT INTO public.business_locations (id, business_id, name, address_text, location) VALUES
  ('loc11111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Location A1', 'Managua 1', extensions.ST_SetSRID(extensions.ST_MakePoint(-86.25, 12.13), 4326)),
  ('loc22222-2222-2222-2222-222222222222', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Location A2', 'Managua 2', extensions.ST_SetSRID(extensions.ST_MakePoint(-86.26, 12.14), 4326)),
  ('loc33333-3333-3333-3333-333333333333', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Location B1', 'Leon 1', extensions.ST_SetSRID(extensions.ST_MakePoint(-86.88, 12.43), 4326))
ON CONFLICT (id) DO NOTHING;

-- N:M Assignment: employee_a assigned ONLY to location_a1
INSERT INTO public.business_member_locations (id, business_member_id, business_location_id) VALUES
  ('bml11111-1111-1111-1111-111111111111', 'a3333333-3333-3333-3333-333333333333', 'loc11111-1111-1111-1111-111111111111')
ON CONFLICT (id) DO NOTHING;
...
SELECT results_eq(
  ...
  ARRAY['loc11111-1111-1111-1111-111111111111'::uuid, 'loc22222-2222-2222-2222-222222222222'::uuid],
...
SELECT results_eq(
  'SELECT id FROM public.business_locations WHERE id = ''loc11111-1111-1111-1111-111111111111''',
  ARRAY['loc11111-1111-1111-1111-111111111111'::uuid],
  'Employee A can view assigned location A1'
); -- 1 assertion

SELECT is_empty(
  'SELECT id FROM public.business_locations WHERE id = ''loc22222-2222-2222-2222-222222222222''',
  'Employee A denied viewing unassigned location A2'
); -- 1 assertion

SELECT is_empty(
  'SELECT id FROM public.business_locations WHERE id = ''loc33333-3333-3333-3333-333333333333''',
